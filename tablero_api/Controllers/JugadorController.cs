...
namespace tablero_api.Controllers
{
    ...
    public class JugadorController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> Put(int id, [FromBody] JugadorDto dto)
        {
            var jugador = await _service.GetByIdAsync(id);
            ...
            jugador.Estatura = dto.estatura;
            jugador.Nacionalidad = dto.Nacionalidad;
            jugador.Edad = dto.Edad;
            jugador.id_Equipo = dto.id_Equipo; 


            await _service.UpdateAsync(jugador);
            return Ok();
        }
